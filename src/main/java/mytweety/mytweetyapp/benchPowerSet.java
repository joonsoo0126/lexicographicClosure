...
public class benchPowerSet {
    ...
    public static class MyState {
        ...
        public void setup() throws IOException{
            ...
            this.rankedKnowledgeBase = new ArrayList<>();
    ...
    public void powerSet(MyState mystate) throws IOException {
        LexicalTester.benchPSet(mystate.rankedKnowledgeBase, mystate.formulaWereCheckingFor);
    }
    public static void main(String[] args) throws IOException, ParserException, RunnerException {
        
        Options opt = new OptionsBuilder().include(benchPowerSet.class.getSimpleName()).forks(2).build();
