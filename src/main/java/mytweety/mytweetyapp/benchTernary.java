...
public class benchTernary {
    ...
    public static class MyState {
        ...
        public void setup() throws IOException {
            ...
            this.formulaWereCheckingFor = (PlFormula) parser
                    .parseFormula(reformatDefeasibleImplication(formulaToCheckFor));
        }
    }
    ...
    public void ternary(MyState mystate) throws IOException {
        LexicalTester.benchTernary(mystate.rankedKBArray, mystate.formulaWereCheckingFor);
    }

    public static void main(String[] args) throws ParserException, RunnerException {

        Options opt = new OptionsBuilder().include(benchTernary.class.getSimpleName()).forks(2).build();
